...
export default function Footer() {
  return (
    <footer className="absolute w-full h-[400px]   mt-[150px] overflow-hidden">
      {/* Background Video */}
      <video
        autoPlay
        loop
      ...
      <div className="relative z-10 h-full w-full bg-black/60  px-8 py-6 flex flex-col justify-between">
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 text-sm">
          ...
          <div className="flex flex-col items-center md:items-start text-center md:text-left">
            <img
              ...
              className="w-20 mb-4"
            />
            <p className="font-semibold">Chhatrapati Shahu Ji Maharaj University, Kanpur</p>
          ...
          <div className="flex flex-col items-center md:items-start">
            ...
            {["Logo Download", "Copyrights", "Hyperlinking Policy", "Terms & Conditions", "Privacy Policy", "Disclaimer"].map((item, idx) => (
              <a href="#" key={idx} className="hover:underline text-sm">
                {item}
              </a>
            ))}
          </div>
        ...
        {/* Bottom Bar */}
        <div className="mt-6 pt-3 border-t border-gray-400 text-xs text-center">
          <p>
